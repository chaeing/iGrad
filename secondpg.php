...
<link rel="stylesheet" type="text/css" href="secondpg.css">
...
<div class="row">
  ...
  <div class="col-md-12 mainframe">
        ...
        <div class="col-md-12 widecenter">
            ...
            <div class="col-md-4 sixcircle">
                <?php include "slidemain140.php" ?>
            </div>
    ...
    <script src="slidemain140.php"></script>
